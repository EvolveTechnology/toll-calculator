...
class TollFeeServiceImplTest {
	...
	/*
	 * Feb 2013
	 * 2,9,16,23 are saturday
	 */
	@Test     
	void testGetTollFeeSaturdayFebruary2013() {
		List<LocalDateTime> inputDates=Stream.of(LocalDateTime.of(2013, 02, 02, 8, 8),LocalDateTime.of(2013, 02, 16, 8, 8)
	...
	/*
	 *  Feb 2013
	 * 4,11,18,25 are Monday
	 *NON Free Vehicles Test
	 */
	@Test     
	void testGetTollFeeMondayFebruary2013Car() {
		List<LocalDateTime> inputDates=Stream.of(LocalDateTime.of(2013, 02, 04, 8, 8),LocalDateTime.of(2013, 02, 18, 8, 8)
	 ...
	 * Feb 2013 Monday 4th
	 * 04-02-2013 06:10
	 * As per the Rule it is charged 8.
	 */
	@Test     
	...
	void testGetTollFeeMondayFebruary2013At6Hr10MinAnd20Min() {
		List<LocalDateTime> inputDates=Stream.of(LocalDateTime.of(2013, 02, 04, 06, 10),LocalDateTime.of(2013, 02, 04, 06, 20)).
				collect(Collectors.toList());
	...
	/*
	 * Feb 2013 Monday 4th
	 * 04-02-2013 06:10 && 06:20 && 06:40
	 * As per the Rule max within an hour is charged that is 13 max of(8,13)
	 */
	@Test     
	void testGetTollFeeMondayFebruary2013At6Hr10MinAnd20MinAnd40Min() {
		List<LocalDateTime> inputDates=Stream.of(LocalDateTime.of(2013, 02, 04, 06, 10),LocalDateTime.of(2013, 02, 04, 06, 20),LocalDateTime.of(2013, 02, 04, 06, 40)).
				collect(Collectors.toList());
	...
	/*
	 * Feb 2013 Monday 4th
	 * 04-02-2013 06:10 && 06:20 && 06:40 && 07:10
	 * As per the Rule max within an hour is charged that is max of 8,13 plus 18 =31
	 */
	@Test     
	...
	/*
	 * Feb 2013 Monday 4th
	 * 04-02-2013 06:10 && 06:20 && 06:40 && 07:10 && 08:10
	 * As per the Rule max within an hour is charged that is max of 8,13 plus 18 =31 plus 13 =44
	 */
	@Test     
	void testGetTollFeeMondayFebruary2013At6Hr10MinAnd20MinAnd40MinAnd7Hr10MinAnd8Hr10Min() {
		List<LocalDateTime> inputDates=Stream.of(LocalDateTime.of(2013, 02, 04, 06, 10),LocalDateTime.of(2013, 02, 04, 06, 20),
				LocalDateTime.of(2013, 02, 04, 06, 40),LocalDateTime.of(2013, 02, 04, 07, 10),LocalDateTime.of(2013, 02, 04, 8, 10)).
				collect(Collectors.toList());
	...
	/*
	 * Feb 2013 Monday 4th
	 * 04-02-2013 06:10 && 06:20 && 06:40 && 07:10 && 08:10 && 08:30
	 * As per the Rule max within an hour is charged that is max of 8,13 plus 18 =31 plus 13 =44
	 */
	@Test     
	...
	/*
	 * Feb 2013 Monday 4th
	 * 04-02-2013 06:10 && 06:20 && 06:40 && 07:10 && 08:10 && 08:30 && 15:10
	 * As per the Rule max within an hour is charged that is max of 8,13 plus 18 =31 plus 13 =44 plus 13= 57
	 */
	@Test     
	...
	/*
	 * Feb 2013 Monday 4th
	 * 04-02-2013 06:10 && 06:20 && 06:40 && 07:10 && 08:10 && 08:30 && 15:10 && 15:30
	 * As per the Rule max within an hour is charged that is max of 8,13 plus 18 =31 plus 13 =44 plus 
	 * max of (13,18) is 18= 62 but it can't go beyond 60 for a day.
	 */
	@Test     
	void testGetTollFeeMondayFebruary2013At6Hr10MinAnd20MinAnd40MinAnd7Hr10MinAnd8Hr10MinAnd8Hr30MinAnd15Hr10MinAnd15HrMin30() {
		List<LocalDateTime> inputDates=Stream.of(LocalDateTime.of(2013, 02, 04, 06, 10),LocalDateTime.of(2013, 02, 04, 06, 20),
				LocalDateTime.of(2013, 02, 04, 06, 40),LocalDateTime.of(2013, 02, 04, 07, 10),LocalDateTime.of(2013, 02, 04, 8, 10)
				,LocalDateTime.of(2013, 02, 04, 8, 30),LocalDateTime.of(2013, 02, 04, 15, 10),LocalDateTime.of(2013, 02, 04, 15, 30)).
				collect(Collectors.toList());
	 ...
	 * 05-02-2013 06:10
	 * 
	 * And Feb 2013 Wednesday 6th
	 * 06-02-2013 17:10 && 18:10
	 * 
	...
	void testGetTollFeeMondayFebruary2013MultipleDatesMondayPlusTuesdayPlusWednesday() {
		List<LocalDateTime> inputDates=Stream.of(LocalDateTime.of(2013, 02, 04, 06, 10),LocalDateTime.of(2013, 02, 04, 06, 20),
				LocalDateTime.of(2013, 02, 04, 06, 40),LocalDateTime.of(2013, 02, 04, 07, 10),LocalDateTime.of(2013, 02, 04, 8, 10)
				,LocalDateTime.of(2013, 02, 04, 8, 30),LocalDateTime.of(2013, 02, 04, 15, 10),LocalDateTime.of(2013, 02, 04, 15, 30),
				LocalDateTime.of(2013, 02, 05, 6, 10),LocalDateTime.of(2013, 02, 06, 17, 10),LocalDateTime.of(2013, 02, 06, 18, 10)).
				collect(Collectors.toList());
